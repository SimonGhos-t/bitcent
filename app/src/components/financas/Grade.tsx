...
export default function Grade(props: GradeProps) {
	function renderizarItem(transacao: Transacao) {
		return (
			...
			>
				<div
					className={`absolute top-0 left-0 w-full h-full bg-linear-to-r opacity-60 ${transacao.tipo === TipoTransacao.RECEITA ? 'from-teal-500 via-green-600 to-teal-700' : 'from-pink-500 via-red-600 to-pink-700'}`}
				></div>
